...
replace mongoshake => ./mongoshake

require (
	github.com/DataDog/zstd v1.4.0 // indirect
	github.com/Shopify/sarama v1.23.2-0.20190905035502-6cdd596cc93a
	...
	github.com/klauspost/compress v1.10.1-0.20200216174641-59173b57be0c // indirect
